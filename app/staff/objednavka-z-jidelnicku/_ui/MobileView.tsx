...
export default function MobileView({
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-[24px] border border-[#bde7c8] bg-white p-4 shadow-[0_12px_32px_rgba(27,54,39,0.05)]">
        <div className="grid gap-2">
          <button
            ...
            className={cls(
              ...
              customerType === "zakaznik"
                ...
                : "border-[#dff2e5] bg-white text-[#0b7c4d]"
            )}
          >
            <div className="text-[15px] font-extrabold">Zákazník</div>
          </button>
          ...
          >
            <div className="text-[15px] font-extrabold">Fakturovaný zákazník</div>
          </button>
        </div>
        ...
        <div className="mt-3 flex gap-2">
            ...
            {customerType === "zakaznik" ? (
              <>
                <input
                  ...
                  className="w-full rounded-full border border-[#bde7c8] bg-white px-4 py-3 text-[14px] font-semibold text-[#182033] outline-none focus:border-[#08a35c]"
                />
                    ...
                    <div className="grid gap-2">
                      {filteredProfiles.map((c) => (
                        <button
                          ...
                          className="rounded-[14px] border border-[#dff2e5] bg-[#f5fbf7] px-4 py-3 text-left"
                        >
                          <div className="text-[14px] font-extrabold text-[#182033]">
                            {c.full_name || "Bez jména"}
                          </div>
                          <div className="mt-1 text-[13px] font-extrabold text-[#0b7c4d]">
          ...
          <button
            ...
            className="inline-flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-[16px] border border-[#78d3a0] bg-white text-[24px] font-extrabold text-[#0b7c4d]"
          >
            +
          </button>
        </div>
      ...
      <div className="rounded-[24px] border border-[#bde7c8] bg-white p-4 shadow-[0_12px_32px_rgba(27,54,39,0.05)]">
        ...
        <button
          ...
          className="mt-3 w-full rounded-[14px] border border-[#dff2e5] bg-white px-5 py-2.5 text-[15px] font-extrabold text-[#0b7c4d]"
        >
            ...
            <div className="grid gap-3">
              {activeItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="text-[15px] font-extrabold text-[#0b2149]">{item.name}</div>

                    <div className="mt-1 text-[13px] font-bold text-[#0b7c4d]">
                      {item.subtitle || "—"}
                    </div>
                    ...
                    <div className="mt-3 flex items-center justify-end gap-2">
                      {qty <= 0 ? (
                        <button
                          ...
                          className="rounded-full border border-[#78d3a0] bg-white px-5 py-2 text-[14px] font-extrabold text-[#0b7c4d]"
                        >
                          Přidat
                        </button>
                      ) : (
      ...
      {saveMsg ? <div className="text-sm font-semibold text-[#0b7c4d]">{saveMsg}</div> : null}

      <button
        type="button"
        onClick={() => setShowSummary(true)}
        className={cls(
          "w-full rounded-full px-5 py-3 text-[15px] font-extrabold transition",
          cartCount > 0
